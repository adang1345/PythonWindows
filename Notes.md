...
- Install [HTML Help Compiler](http://web.archive.org/web/20160201063255/http://download.microsoft.com/download/0/A/9/0A939EF6-E31C-430F-A3DF-DFAE7960D564/htmlhelp.exe).
- Install [Windows SDK 10.0.15063.468](https://go.microsoft.com/fwlink/p/?LinkId=845298), which is the latest version that is compatible with Tcl/Tk 8.6.4 (https://core.tcl-lang.org/tk/tktview/9e31fd9449). It is OK to have a newer Windows SDK installed as well, in which case Windows SDK 10.0.15063.468 is used to build Tcl/Tk only while the newest installed Windows SDK is used for other components.
...
- Apply `support-vs-2026-1.patch` to support building with Visual Studio 2026 using the v145 toolset and to avoid an issue where Tcl/Tk is not compatible with the Windows 11 SDK (derived from https://github.com/python/cpython/commit/0e4ad88ff8956d9289ab0a1314636ac15b374459, https://github.com/python/cpython/commit/eede148296bf3b4578b92ed6a07f2733a0f1c341, https://github.com/python/cpython/commit/c05e491a69df3fe0a8be91eeddd330792ada6755, https://github.com/python/cpython/commit/45faf151c693b6f13f78926761caea6df7242024, and https://github.com/python/cpython/commit/c06f4f43015528db45bd6b44b46c057d88b38583).
...
- Apply `support-vs-2026-2.patch` to support building with Visual Studio 2026 using the v145 toolset and the Windows 11 SDK. Also avoid an issue where Tcl/Tk is not compatible with the Windows 11 SDK. (Derived from https://github.com/python/cpython/commit/30f4fa456ef626ad7a92759f492ec7a268f7af4e, https://github.com/python/cpython/commit/c83ec055a09137e4b24f70e3bb5f887dc0ae6e8e, https://github.com/python/cpython/commit/cba5ddf088683859dd022d04cb3726d56f5f0297, https://github.com/python/cpython/commit/df4852cbe4b757e8b79506d73a09ec8a1b595970, https://github.com/python/cpython/commit/0e4ad88ff8956d9289ab0a1314636ac15b374459, https://github.com/python/cpython/commit/eede148296bf3b4578b92ed6a07f2733a0f1c341, https://github.com/python/cpython/commit/c05e491a69df3fe0a8be91eeddd330792ada6755, https://github.com/python/cpython/commit/45faf151c693b6f13f78926761caea6df7242024, and https://github.com/python/cpython/commit/c06f4f43015528db45bd6b44b46c057d88b38583. Also used the suggestion at https://github.com/python/cpython/issues/84133#issuecomment-1093865746.)
...
- Install [HTML Help Compiler](http://web.archive.org/web/20160201063255/http://download.microsoft.com/download/0/A/9/0A939EF6-E31C-430F-A3DF-DFAE7960D564/htmlhelp.exe).
- Install Sphinx 2.4.5 to a Python 3.6 venv and set `PYTHON` to the location of the Python executable.
- Apply `support-vs-2026-3.patch` to support building with Visual Studio 2026 using the v145 toolset and the Windows 11 SDK (derived from https://github.com/python/cpython/commit/45faf151c693b6f13f78926761caea6df7242024 and https://github.com/python/cpython/commit/c06f4f43015528db45bd6b44b46c057d88b38583).
...
- Install [HTML Help Compiler](http://web.archive.org/web/20160201063255/http://download.microsoft.com/download/0/A/9/0A939EF6-E31C-430F-A3DF-DFAE7960D564/htmlhelp.exe).
- Install Sphinx 2.4.5 to a Python 3.6 venv and set `PYTHON` to the location of the Python executable.
- Apply `support-vs-2026-4.patch` for 3.8.11-3.8.12 or `support-vs-2026-5.patch` for 3.8.13 or higher to support building with Visual Studio 2026 using the v145 toolset and the Windows 11 SDK (derived from https://github.com/python/cpython/commit/45faf151c693b6f13f78926761caea6df7242024 and https://github.com/python/cpython/commit/c06f4f43015528db45bd6b44b46c057d88b38583).
...
- Apply `support-vs-2026-6.patch` to support building with Visual Studio 2026 using the v145 toolset and the Windows 11 SDK (derived from https://github.com/python/cpython/commit/45faf151c693b6f13f78926761caea6df7242024 and https://github.com/python/cpython/commit/c06f4f43015528db45bd6b44b46c057d88b38583).
...
- Install [HTML Help Compiler](http://web.archive.org/web/20160201063255/http://download.microsoft.com/download/0/A/9/0A939EF6-E31C-430F-A3DF-DFAE7960D564/htmlhelp.exe).
- Install Sphinx 3.5.4 to a Python 3.6 venv and set `PYTHON` to the location of the Python executable.
- Apply `support-vs-2026-7.patch` to support building with Visual Studio 2026 using the v145 toolset (derived from https://github.com/python/cpython/commit/c06f4f43015528db45bd6b44b46c057d88b38583).
...
- Apply `enable-arm64-1.patch` to enable ARM64 builds. This also fixes https://github.com/python/cpython/issues/123915 and https://github.com/python/cpython/issues/150400.
...
- Apply `support-vs-2026-8.patch` to support building with Visual Studio 2026 using the v145 toolset (derived from https://github.com/python/cpython/commit/c06f4f43015528db45bd6b44b46c057d88b38583).
- Apply `build-full-installer-5.patch` to include debug symbols, debug binaries, and the Universal CRT in the installer.
- Apply `enable-arm64-2.patch` to enable ARM64 builds. This also fixes https://github.com/python/cpython/issues/150400.
- Apply `fix-ucrt-2.patch` to fix error installing Universal C Runtime (https://github.com/python/cpython/issues/138896).
- Run `buildrelease.bat`.
